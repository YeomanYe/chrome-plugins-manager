<template>
    <div id="option">
        ...
        <div class="list">
            ...
            <p>
                <input type="range" class="range-style" min="6" max="9" step="1" :value="showWindowSize"
                       @input="changeWindowSize">
            </p>
        </div>
        ...
        <div class="list">
            ...
            <p>
                <input type="range" class="range-style" min="1" max="3" step="1" :value="showIconSize"
                       @input="changeIconSize">
            </p>
        </div>

        <!-- 配置分组 -->
        <div class="list" id="group">
            <h1><span>{{i18n.optionGroupTitle}}</span>
                <button @click="openFile" class="import">导入</button>
                <button class="export" @click="exportData">导出</button>
            </h1>
            <input @change="importData" type="file" hidden/>
            ...
            <ul class="group-list gclearfix">
                <li v-for="(item, index) in group.list" :class="index === groupIndex ? 'cur' : ''"
                ...
                <li class="group-add" @click="addGroup">
                    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path d="M939.939489 459.072557 562.339502 459.072557 562.339502 83.519182 462.055494 83.519182 462.055494 459.072557 84.455507 459.072557 84.455507 559.356564 462.055494 559.356564 462.055494 939.003164 562.339502 939.003164 562.339502 559.356564 939.939489 559.356564Z"
                              fill="#636363"></path>
                    </svg>
                </li>
            </ul>
        ...
        <div class="list">
            ...
            <ul class="radio-btn">
                <li>
                    <label>
                        <input type="radio" name="ext_sort" value="name" v-model="sortType"
                ...
                <li>
                    <label>
                        <input type="radio" name="ext_sort" value="rank" v-model="sortType"
                               @click="changeSortType('rank')">
                        <span class="radio-btn-input"></span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openFile() {
        document.querySelector('.list input[type="file"]').click()
      },
      importData(e) {
        ...
        if (files.length) {
          ...
          reader.onload = function () {
            ...
            self.groupIndex = 0;
            self.group = data._group_;
            console.log('data',data);
            Storage.setAll(data);
          };
          reader.readAsText(file);
          //清空value，避免两次导入同一个文件不生效
      ...
      async exportData() {
        ...
        FileSaver.saveAs(blob, 'manager.json');
      },
      deleteGroup(index) {
        this.groupIndex = index
